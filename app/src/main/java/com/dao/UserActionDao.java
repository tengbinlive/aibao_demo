...
public class UserActionDao extends AbstractDao<UserAction, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property AppointId = new Property(3, String.class, "appointId", false, "APPOINT_ID");
        public final static Property Icon = new Property(4, String.class, "icon", false, "ICON");
        public final static Property Icon_disabled = new Property(5, String.class, "icon_disabled", false, "ICON_DISABLED");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER_ACTION\" (" + //
                ...
                "\"TYPE\" TEXT," + // 1: type
                "\"TITLE\" TEXT," + // 2: title
                "\"APPOINT_ID\" TEXT," + // 3: appointId
                "\"ICON\" TEXT," + // 4: icon
                "\"ICON_DISABLED\" TEXT," + // 5: icon_disabled
                "\"DATE\" INTEGER);"); // 6: date
    }
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, UserAction entity) {
        stmt.clearBindings();
        ...
        String icon_disabled = entity.getIcon_disabled();
        if (icon_disabled != null) {
            stmt.bindString(6, icon_disabled);
        }
    ...
    public UserAction readEntity(Cursor cursor, int offset) {
        UserAction entity = new UserAction( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // appointId
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // icon
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // icon_disabled
    ...
    public void readEntity(Cursor cursor, UserAction entity, int offset) {
        ...
        entity.setAppointId(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setIcon(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setIcon_disabled(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setDate(cursor.isNull(offset + 6) ? null : new java.util.Date(cursor.getLong(offset + 6)));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(UserAction entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
