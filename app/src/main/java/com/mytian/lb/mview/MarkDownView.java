...
public class MarkDownView extends WebView {
    ...
    private EloadProgress eloadProgress;
    private final static String LOAD_HTML = "file:///android_asset/markdown.html";
    private String str = "";

    public void setEloadProgress(EloadProgress eloadProgress) {
        this.eloadProgress = eloadProgress;
    }
    ...
    public interface EloadProgress {
        void start();
